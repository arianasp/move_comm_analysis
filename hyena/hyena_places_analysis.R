...
fpt.thresh <- 1*60*60 #threshold of first passage time to consider something a 'place' (default 10 min = 600 sec)
...
min.separation.distance <- 200 #places less than this distance apart will be aggregated into one place using the chain rule
...
fpt.savename <- '~/Dropbox/hyenas/results/places/first_passage_times.RData' #where to store fpt data
